...
\begin{document}
\name{Andrea Pusineri}
\tagline{Cloud Architect - AWS Community Builder}
\photo{3cm}{cv-pic}
\personalinfo{%
...
\begin{itemize}
\item Lead architecture design and delivery of scalable, secure and cost-effective AWS environments for enterprise clients, from requirements to production.
\item In depth experience with cloud posture assessments, security reviews, 
      and governance frameworks (AWS Well-Architected, CIS Benchmarks).
\item Occasional use of other CSPs including GCP and Oracle Cloud.
\end{itemize}
